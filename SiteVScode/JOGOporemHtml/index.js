...
let jogoAtivo = true // controla se o jogo está ativo ou não, ou seja se o Amir morreu ou não
...
function explorarIra() {
    ...
    console.log("Meus amigos desde sempre me apoaiaram para me ajudar na montagem da bicicleta dos sonhos.")
    ...
    interagirComNPCiran()
    verificarMorte() // Verifica se o jogador morreu após interagir com NPCs
}
...
function interagirComNPCiran() {
    ...
    verificarMorte() // Verifica se o jogador morreu após explorar o Irã
...
function explorarAfeganistao() {
    ...
    console.log("Aqui é diferente mas quando caminhei pelas ruas pude fazer novas amizadades!")
    console.log("Conversei bastante com eles e eles gostaram muito de mim.")
    console.log("Contei sobre meus sonhos e desejos.")
    console.log("Eles me deram um bom feedback sobre meu sonhos!")
    ...
    console.log("Eu sinto saudade dos meus amigos de la, mas sei que preciso continuar por aqui.")
    console.log("Enfim.................")
...
function interagirComNPCAfeganistao() {
    ...
    console.log("Ele falou que poderia ser seu treinador e poderia te ajudar na sua caminhada!")
    console.log("Ele disse que te acha uma garoto muito promissor!")
    ...
    verificarMorte() // Verifica se o jogador morreu após explorar o Afeganistão
    if (!jogoAtivo) return // Se o jogo não estiver ativo, retorna
...
function explorarSuecia() {
    ...
    if (jogoAtivo) { // Verifica se o jogador está vivo
...
function interagirComNPCsuecia() {
    ...
    verificarMorte() // Verifica se o jogador morreu após explorar a Suécia
}
...
function iniciarJogo() {
    ...
    while (jogoAtivo) {
        mostrarMenu()
        opcao = prompt("Digite o número da opção desejada: OBS.: CASO EXPLORE TODOS OS PAISES INDICO QUE SIGA A ORDEM 1 2 3 PARA SUA EXPERIENCIA SER MAIS SATISFATORIA")
